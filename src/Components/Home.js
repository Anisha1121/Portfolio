    ...
    <div >
      ...
      <div className='AboutPage'>
        <div className='AboutText'>
          <h1 className='AboutTextHeading'> <b>Brief introduction</b></h1>
          <p>
            ...
            Also, I love <b>exploring new places and stuff and yeah coffee too!</b> <CiCoffeeCup style={{scale:"1.5", rotate:"15deg"}}/>   
          </p>
        </div>
        <Tilt>
